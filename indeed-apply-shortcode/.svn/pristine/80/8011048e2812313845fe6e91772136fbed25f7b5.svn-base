	...
	*/
	...
	class Indeed_Apply {
		...
		public function run () {
			...
			//Change priority of wpautop
			remove_filter( 'the_content', 'wpautop' );
			add_filter( 'the_content', 'wpautop' , 99);

			//Don't apply wpautop to shortcode content
		...
		public function ia_settings_text () {
			echo "<p>See the <a target='_blank' href='https://www.indeed.com/api'>Indeed Apply for WordPress guide</a> to enable Indeed Apply for your WordPress logins.</p>";
